...
@see void BSTree<DataType,KeyType>::clearHelper(BSTreeNode *&ptr)
*/
template <typename DataType, typename KeyType>
...
@param nodeDataItem Address of data item that node will hold
 @param leftPtr Pointer to left node
 @param rightPtr Pointer to right node
*/
template <typename DataType, typename KeyType>
