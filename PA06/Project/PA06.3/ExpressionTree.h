...
class ExprTree {
  ...
  private:
    ...
    DataType evalHelper(ExprTreeNode* nodePtr) const;
    void expressionHelper(ExprTreeNode* nodePtr) const;
    bool isEmpty()const;
    void copyHelper(ExprTreeNode*& sourcePtr, ExprTreeNode*& newPtr);
